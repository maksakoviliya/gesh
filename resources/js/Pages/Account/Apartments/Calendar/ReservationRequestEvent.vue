...
<template>
	<div class="">
		<div class="flex items-center gap-2">
			<Avatar :src="props.event.data.reservation_request.user.avatar" />
			<div>
				<div class="font-medium text-sm dark:text-white">
					{{ props.event.data.reservation_request.user.name }}
				</div>
				<div class="font-medium text-sm dark:text-slate-400">
					{{ props.event.data.reservation_request.user.email }}
					<span v-if="props.event.data.reservation_request.user.phone"
						>| {{ props.event.data.reservation_request.user.phone }}</span
					>
				</div>
			</div>
		</div>
