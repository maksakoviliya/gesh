			...
			<div class="relative flex-col md:flex-row flex items-start gap-4 mt-6">
				<div class="md:w-1/2 lg:w-2/3">
					<Heading
						...
						subtitle="Вы успешно забронировали жилье"
					/>
					<div>
					...
					<div>
						...
						<div class="mt-3 flex gap-4 items-center">
							<a
								...
								"
								v-if="props.reservation.data.status === 'paid'"
								class="relative transition w-auto rounded-lg bg-white dark:bg-slate-800 border-black dark:border-slate-400 text-black dark:text-slate-300 hover:opacity-60 text-md py-3 px-12 font-semibold border-2"
							>
								Ваучер
							</a>
							<div
								v-else
								class="text-neutral-600 dark:text-slate-400"
							>
								Ожидаем проведения оплаты системой
							</div>
							<!--							<ButtonComponent-->
							<!--								:disabled="true"-->
							<!--								:auto-width="true"-->
