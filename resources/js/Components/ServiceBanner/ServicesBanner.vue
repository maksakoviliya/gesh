<script setup>
	...
	import ServiceBannerLink from '@/Components/ServiceBanner/ServiceBannerLink.vue'
</script>

<template>
	<div class="grid gap-4 grid-cols-1 md:grid-cols-2 border-b dark:border-slate-700 pb-7">
		<ServiceBannerLink
