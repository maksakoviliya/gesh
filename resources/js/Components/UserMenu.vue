...
onMounted(() => {
    axios.get(route('has_unread_notifications'))
        .then((res) => {
...
<template>
    <div class="relative">
        ...
        <Popover max-width-class="max-w-[40vw] md:max-w-[22vw]" position="left">
            <template #toggle>
                <div
                ...
                >
                    ...
                    <Indicator :count="unreadNotificationsCount" hidden-count/>
                </div>
            </template>
            <template #content>
                <div
