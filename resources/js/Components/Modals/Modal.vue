<script setup>
	...
	const emit = defineEmits(['onClose', 'onSubmit', 'onSecondaryAction'])
	...
	<Transition name="fade">
		...
		>
            ...
            `"
				>
					<div
						class="translate h-full lg:h-auto md:h-auto border-0 md:rounded-lg shadow-lg relative flex flex-col w-full bg-white dark:bg-slate-800 dark:text-slate-200 outline-none focus:outline-none"
					>
						<div class="flex items-center p-6 rounded-t justify-center relative border-b">
							<button
