...
<template>
        <SwitchGroup as="div" class="flex items-center gap-3 text-neutral-500 ">
            <SwitchLabel class="cursor-pointer  flex flex-col" :class="!darkMode ? 'text-neutral-800 dark:text-slate-300' : ''">
            ...
            <SwitchLabel class="cursor-pointer flex items-center gap-1" :class="darkMode ? 'text-neutral-800 dark:text-slate-200' : ''">
