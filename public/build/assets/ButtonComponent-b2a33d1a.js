...
`);const F=["disabled"],G={__name:"ButtonComponent",props:{label:String,onClick:Function,disabled:Boolean|null,outline:Boolean|null,small:Boolean|null,autoWidth:Boolean|null,fontLight:Boolean|null,bgClass:{type:String,default:"bg-sky-600"},borderClass:{type:String,default:"border-sky-600"}},setup(o){const n=o,i=h(()=>`relative
    disabled:opacity-30
    ...
    ${n.small?"border-[1px]":"border-2"}`);return(a,e)=>(Y(),I("button",{disabled:o.disabled,onClick:e[0]||(e[0]=(...v)=>o.onClick&&o.onClick(...v)),class:L(i.value)},[a.$slots.icon?O(a.$slots,"icon",{key:0}):V("",!0),j(" "+q(o.label),1)],10,F))}};export{G as _,R as c,U as g};
