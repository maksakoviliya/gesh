import{d as N,r as z,D as x,b as h,v as E,a1 as M,a2 as T,h as m,o as Y,j,A as I,m as O,k as L,t as V,n as X}from"./app-719eb162.js";const q={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let A=0;var D=o=>o.replace(/[<>"&]/g,n=>q[n]||n),W=o=>o+A++;const f={},F=o=>{const{name:n,paths:i=[],d:a,polygons:e=[],points:v}=o;a&&i.push({d:a}),v&&e.push({points:v}),f[n]=Object.assign({},o,{paths:i,polygons:e}),f[n].minX||(f[n].minX=0),f[n].minY||(f[n].minY=0)},R=(...o)=>{for(const n of o)F(n)},U=N({name:"OhVueIcon",props:{name:{type:String,validator:o=>!o||o in f||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${o}".
