import{k as s,a as r,c as i,s as d,f as u,i as c,t as b,n as m}from"./app-851483fe.js";const k=["disabled"],y={__name:"ButtonComponent",props:{label:String,onClick:Function,disabled:Boolean|null,outline:Boolean|null,small:Boolean|null,autoWidth:Boolean|null,fontLight:Boolean|null,circle:Boolean|null,bgClass:{type:String,default:"bg-sky-600 dark:bg-sky-800"},borderClass:{type:String,default:"border-sky-600 dark:border-sky-800"},textClass:{type:String,default:"text-white"},danger:Boolean},setup(e){const l=e,a=s(()=>`relative
    disabled:opacity-30
