import{d as N,r as z,K as x,c as h,s as E,a1 as M,a2 as T,h as m,o as Y,i as j,z as I,l as O,j as L,t as V,n as X}from"./app-5b5c745b.js";const q={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let W=0;var A=o=>o.replace(/[<>"&]/g,n=>q[n]||n),D=o=>o+W++;const f={},F=o=>{const{name:n,paths:i=[],d:a,polygons:e=[],points:v}=o;a&&i.push({d:a}),v&&e.push({points:v}),f[n]=Object.assign({},o,{paths:i,polygons:e}),f[n].minX||(f[n].minX=0),f[n].minY||(f[n].minY=0)},P=(...o)=>{for(const n of o)F(n)},R=N({name:"OhVueIcon",props:{name:{type:String,validator:o=>!o||o in f||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${o}".
