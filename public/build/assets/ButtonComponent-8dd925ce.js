import{d as N,r as z,D as x,b as h,s as E,a2 as M,a3 as T,h as m,o as Y,j,z as I,l as O,p as L,t as V,n as X}from"./app-b4b70f8a.js";const q={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let D=0;var W=o=>o.replace(/[<>"&]/g,n=>q[n]||n),A=o=>o+D++;const f={},F=o=>{const{name:n,paths:i=[],d:a,polygons:e=[],points:v}=o;a&&i.push({d:a}),v&&e.push({points:v}),f[n]=Object.assign({},o,{paths:i,polygons:e}),f[n].minX||(f[n].minX=0),f[n].minY||(f[n].minY=0)},R=(...o)=>{for(const n of o)F(n)},U=N({name:"OhVueIcon",props:{name:{type:String,validator:o=>!o||o in f||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${o}".
