import{d as N,r as z,A as x,b as h,s as E,_ as M,$ as T,h as m,o as Y,k as I,x as O,m as j,q,t as L,n as V}from"./app-a3a671a6.js";const X={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let A=0;var W=o=>o.replace(/[<>"&]/g,n=>X[n]||n),D=o=>o+A++;const f={},F=o=>{const{name:n,paths:i=[],d:a,polygons:e=[],points:v}=o;a&&i.push({d:a}),v&&e.push({points:v}),f[n]=Object.assign({},o,{paths:i,polygons:e}),f[n].minX||(f[n].minX=0),f[n].minY||(f[n].minY=0)},R=(...o)=>{for(const n of o)F(n)},U=N({name:"OhVueIcon",props:{name:{type:String,validator:o=>!o||o in f||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${o}".
