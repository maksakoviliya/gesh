import{m as N,r as z,l as x,g as h,s as E,aV as M,bg as T,H as m,o as Y,d as j,f as I,j as O,h as V,t as L,n as X}from"./app-af583697.js";const q={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let H=0;var A=o=>o.replace(/[<>"&]/g,n=>q[n]||n),D=o=>o+H++;const f={},F=o=>{const{name:n,paths:i=[],d:a,polygons:e=[],points:v}=o;a&&i.push({d:a}),v&&e.push({points:v}),f[n]=Object.assign({},o,{paths:i,polygons:e}),f[n].minX||(f[n].minX=0),f[n].minY||(f[n].minY=0)},U=(...o)=>{for(const n of o)F(n)},G=N({name:"OhVueIcon",props:{name:{type:String,validator:o=>!o||o in f||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${o}".
...
`);const P=["disabled"],J={__name:"ButtonComponent",props:{label:String,onClick:Function,disabled:Boolean|null,outline:Boolean|null,small:Boolean|null,fontLight:Boolean|null,bgClass:{type:String,default:"bg-sky-600"},borderClass:{type:String,default:"border-sky-600"}},setup(o){const n=o,i=h(()=>`relative
    disabled:opacity-30
    ...
    ${n.small?"border-[1px]":"border-2"}`);return(a,e)=>(Y(),j("button",{disabled:o.disabled,onClick:e[0]||(e[0]=(...v)=>o.onClick&&o.onClick(...v)),class:X(i.value)},[a.$slots.icon?I(a.$slots,"icon",{key:0}):O("",!0),V(" "+L(o.label),1)],10,P))}};export{J as _,U as c,G as g};
