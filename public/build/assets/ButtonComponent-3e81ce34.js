import{v as N,r as z,s as k,m as h,i as E,W as M,X as T,k as m,o as Y,d as I,l as O,f as X,h as j,t as L,n as V}from"./app-ed995093.js";const W={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let q=0;var A=o=>o.replace(/[<>"&]/g,n=>W[n]||n),D=o=>o+q++;const f={},F=o=>{const{name:n,paths:i=[],d:a,polygons:e=[],points:v}=o;a&&i.push({d:a}),v&&e.push({points:v}),f[n]=Object.assign({},o,{paths:i,polygons:e}),f[n].minX||(f[n].minX=0),f[n].minY||(f[n].minY=0)},R=(...o)=>{for(const n of o)F(n)},U=N({name:"OhVueIcon",props:{name:{type:String,validator:o=>!o||o in f||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${o}".
