import{d as N,r as z,D as x,b as h,v as E,a2 as M,a3 as T,h as m,o as Y,j,A as I,m as O,q,t as L,n as V}from"./app-dcea8354.js";const X={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","&":"&amp;"};let A=0;var D=o=>o.replace(/[<>"&]/g,n=>X[n]||n),W=o=>o+A++;const f={},F=o=>{const{name:n,paths:i=[],d:a,polygons:e=[],points:v}=o;a&&i.push({d:a}),v&&e.push({points:v}),f[n]=Object.assign({},o,{paths:i,polygons:e}),f[n].minX||(f[n].minX=0),f[n].minY||(f[n].minY=0)},R=(...o)=>{for(const n of o)F(n)},U=N({name:"OhVueIcon",props:{name:{type:String,validator:o=>!o||o in f||(console.warn(`Invalid prop: prop "name" is referring to an unregistered icon "${o}".
...
`);const H=["disabled"],G={__name:"ButtonComponent",props:{label:String,onClick:Function,disabled:Boolean|null,outline:Boolean|null,small:Boolean|null,autoWidth:Boolean|null,fontLight:Boolean|null,bgClass:{type:String,default:"bg-sky-600"},borderClass:{type:String,default:"border-sky-600"},textClass:{type:String,default:"text-white"},danger:Boolean},setup(o){const n=o,i=h(()=>`relative
    ...
    ${n.small?"border-[1px]":"border-2"}`);return(a,e)=>(Y(),j("button",{disabled:o.disabled,onClick:e[0]||(e[0]=(...v)=>o.onClick&&o.onClick(...v)),class:V(i.value)},[a.$slots.icon?I(a.$slots,"icon",{key:0}):O("",!0),q(" "+L(o.label),1)],10,H))}};export{G as _,R as c,U as g};
