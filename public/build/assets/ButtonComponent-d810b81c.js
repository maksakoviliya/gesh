import{m as s,a as r,c as d,k as i,f as u,i as b,t as c,n as k}from"./app-39a0e7e7.js";const m=["disabled"],g={__name:"ButtonComponent",props:{label:String,onClick:Function,disabled:Boolean|null,outline:{type:[Boolean,null]},small:Boolean|null,autoWidth:{type:[Boolean,null]},fontLight:Boolean|null,circle:Boolean|null,bgClass:{type:[String,null],default:"bg-sky-600 dark:bg-sky-800"},borderClass:{type:[String,null],default:"border-sky-600 dark:border-sky-800"},textClass:{type:[String,null],default:"text-white"},danger:Boolean},setup(e){const l=e,a=s(()=>`relative
    disabled:opacity-30
